 ...
 * Practica 1 - Exercici 3
 * Aquest exercici resol un sistema d'equacions lineal utilitzant una matriu i resolent-la per el metode de gauss amb pivotatge de files
 */
...
int gausspivot(int, double **, double *, double);/* funcio que ens calcula les valors dun sistema lineal Ax = b utilitzant el metode de gauss, amb pivotatge, gausspivot es igial que la funcio gauss, lo unic que se li afegeix es la funcio de pivotar files */
